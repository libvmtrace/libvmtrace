...
namespace libvmtrace
{
	class LinuxELFInjector
	{
		...
		const struct
		{
			 ...
			 * syscall
			 */
			const char* data =  "\xEF\xBE\xAD\xDE\x00\x00\x00\x00\x66\x69\x6C\x65\x5F\x65\x78"
				"\x74\x72\x61\x63\x74\x69\x6F\x6E\x00\x48\xC7\xC0\x3F\x01\x00\x00\x48\x8D"
				"\x3D\xE2\xFF\xFF\xFF\x48\xC7\xC6\x01\x00\x00\x00\x0F\x05\x49\x89\xC4\x4C"
				"\x89\xE7\x48\xC7\xC0\x4D\x00\x00\x00\x48\x8B\x35\xBD\xFF\xFF\xFF\x0F\x05"
				"\x48\xC7\xC0\x09\x00\x00\x00\x48\x31\xFF\x48\x8B\x35\xAA\xFF\xFF\xFF\x48"
				"\xC7\xC2\x03\x00\x00\x00\x49\xC7\xC2\x01\x00\x00\x00\x4D\x89\xE0\x4D\x31"
				"\xC9\x0F\x05\x49\x89\xC5\x48\xC7\xC0\x95\x00\x00\x00\x4C\x89\xEF\x48\x8B"
				"\x35\x80\xFF\xFF\xFF\x0F\x05\xCC\x48\xC7\xC0\x1A\x00\x00\x00\x4C\x89\xEF"
				"\x48\x8B\x35\x6C\xFF\xFF\xFF\x48\xC7\xC2\x04\x00\x00\x00\x0F\x05\x48\xC7"
				"\xC0\x96\x00\x00\x00\x4C\x89\xEF\x48\x8B\x35\x52\xFF\xFF\xFF\x0F\x05\x48"
				"\xC7\xC0\x0B\x00\x00\x00\x4C\x89\xEF\x48\x8B\x35\x3F\xFF\xFF\xFF\x0F\x05"
				"\x48\xC7\xC0\x42\x01\x00\x00\x4C\x89\xE7\x48\x8D\x35\x43\xFF\xFF\xFF\x48"
				"\x31\xD2\x4D\x31\xD2\x49\xC7\xC0\x00\x10\x00\x00\x0F\x05";
			size_t size = 0xE3;
			size_t displacement = 0x18;
			size_t interrupt_mmap = 0x82;
		} shellcode{};
